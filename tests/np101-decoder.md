...
`np101_decoder` runs the first four complete Qwen3.5-0.8B text decoder layers:
...
between all layer positions. Position advances only after all four layers succeed.
